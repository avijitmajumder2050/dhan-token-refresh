...
flowchart TD
    ...
    EB -->|Trigger 8 AM IST| Lambda
    Lambda -->|Get Launch Template ID| PS
    Lambda -->|Launch EC2| EC2
    EC2 -->|Run Docker 1| Docker1
    Docker1 -->|Refresh Token| PS
    Docker1 -->|Exit| EC2
    EC2 -->|Run Docker 2| Docker2
    Docker2 -->|Fetch OHLC Data| S3
    Docker2 -->|Exit| EC2
    EC2 -->|Notify| Telegram
